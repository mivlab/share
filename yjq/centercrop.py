...
# centercrop
datapath = r'D:\work\data\MVB_train\preprocessing\train'
...
img_crop = tfs.CenterCrop((64, 64))(img_)
...
for dir in os.listdir(datapath):
    ...
    for name in os.listdir(path1):
        ...
        if x < 5:
            ...
            img[offset:offset+64, offset:offset+64, :] = img_crop
            im = Image.fromarray(img)
        else:
            continue

        im.save(os.path.join(path1,'c_1' + name))
